 ...
 */
public class ThermostatFactory extends ConnectorFactory<ProtobufRenderer> {
    ...
    @Override
    public ProtobufRenderer createComponent(Object source, Map<String, Object> context) {
